...
public class KeyGenerationServiceImplTest {
    ...
    @Test
    public final void testGetPublicKey() throws NoSuchAlgorithmException, InvalidKeySpecException {
        PublicKeyDTO publicKey = keyGenerationService.getPublicKey("shrinivas93");
